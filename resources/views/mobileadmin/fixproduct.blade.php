			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
                        ...
                        <!-- BEGIN USER FORM -->
                        <?php 
                                foreach($productf as $value) {
                                ?>
						<form action="/nhom3/public/admin/product/<?php echo $value->ID ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						@method('PUT')
						@csrf
							<div class="control-group">
								...
								<div class="controls">
                                    ...
                                    <input name="name" type="text" class="span11" placeholder="Product name"  value="<?php echo $value->name ?>" />
                                <?php } ?>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
								<?php foreach($productf as $value) { ?>
									<p><?php echo $value->type_name ?></p>
								<?php } ?>
                                <select name="type_id">
									<?php 
										foreach($protypef as $value) {
									?>
							...
							<div class="control-group">
								...
								<div class="controls">
								<?php foreach($productf as $value) { ?>
									<p><?php echo $value->manu_name ?></p>
								<?php } ?>
                                <select name="manu_id">
									<?php
										
										foreach($manuf as $value){
									?>
								...
								<div class="control-group">
									...
									<div class="controls">
                                    <?php foreach($productf as $value) { ?>
                                        <img src="{{ asset('./img/'.$value->image) }}" alt="" style="max-width: 200px">
										<input type="file" name="fileUpload" id="fileUpload">
										<img src="{{ asset('./img/'.$value->image2) }}" alt="" style="max-width: 200px">
										<input type="file" name="fileUpload2" id="fileUpload2">
										<img src="{{ asset('./img/'.$value->image3) }}" alt="" style="max-width: 200px">
										<input type="file" name="fileUpload3" id="fileUpload3">
										<img src="{{ asset('./img/'.$value->image4) }}" alt="" style="max-width: 200px">
