...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{url('/nhom3/public/mobileadmin/adminindex')}}" title="Go to Home" class="tip-bottom current"><i class="icon-home"></i> Home</a></div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title"> <span class="icon"><a href="{{url('form_manufacture.html')}}"><i class="icon-plus"></i></a></span>
						<h5>Products</h5>
					</div>
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tr class="">
								...
								<td><img src="{{ asset('./img/'.$value->type_img) }}" style="width:100px"></td>
								<td>
									<a href="/nhom3/public/admin/protype/<?php echo $value->type_ID ?>/edit" class="btn btn-success btn-mini">Edit</a>
									<form action="/nhom3/public/admin/protype/<?php echo $value->type_ID ?>" method="POST">
    								@method('DELETE')
									@csrf
