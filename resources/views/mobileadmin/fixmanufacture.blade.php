				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<?php 
                                ...
                                ?>
						<form action="/nhom3/public/admin/manufacture/<?php echo $value->manu_ID ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						@method('PUT')
						@csrf
							<div class="control-group">
								<label class="control-label">Name :</label>
								<div class="controls">
                                    <input name="name" type="text" class="span11" placeholder="Manufacture name" value="<?php echo $value->manu_name ?>" />
                                <?php } ?>
								</div>
							</div>
								<div class="control-group">
									...
									<div class="controls">
                                    <?php foreach($manuf as $value) { ?>
                                        <img src="{{ asset('./img/'.$value->manu_img) }}" alt="" style="max-width: 200px">
