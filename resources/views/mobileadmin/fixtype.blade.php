...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
	<ul>
		<li><a href="/nhom22/public/admin/product"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<?php 
                                foreach($protypesf as $value) {
                                ?>
						<form action="/nhom3/public/admin/protype/<?php echo $value->type_ID ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						@method('PUT')
						@csrf
							<div class="control-group">
								...
								<div class="controls">
                                    ...
                                    <input name="name" type="text" class="span11" placeholder="price" name = "price" value="<?php echo $value->type_name ?>" />
                                <?php } ?>
								</div>
							</div>
								<div class="control-group">
									...
									<div class="controls">
                                    <?php foreach($protypesf as $value) { ?>
                                        <img src="{{ asset('./img/'.$value->type_img) }}" alt="" style="max-width: 200px">
